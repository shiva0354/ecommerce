		    ...
		    <div class="menu">
		      <ul id="menu" >
				...
				<li><a href="#"><i class="fa fa-shopping-cart"></i><span>Orders</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
		            <li><a href="order.php">Placed Order</a></li>
		            <li><a href="cancel_order.php">Cancelled Order</a></li>		            
		          </ul>
		        </li>					        
		        <li><a href="user_list.php"><i class="fa fa-users"></i><span>Users</span></a></li>
				...
				<li><a href="#"><i class="fa fa-rss"></i><span>Blog</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         ...
		         <li><a href="#"><i class="fa fa-cog"></i><span>Company Setting</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	 <ul id="menu-academico-sub" >
			            ...
			            <li id="menu-academico-boletim" ><a href="t&c.php">Terms & Conditions</a></li>
			            <li id="menu-academico-boletim" ><a href="privacy.php">Privacy Policy</a></li>
			            <li id="menu-academico-boletim" ><a href="return_policy.php">Return Policy</a></li>
		             </ul>
		         </li>
