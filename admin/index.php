	 ...
	 <div class="market-updates">
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-1">
					...
					<?php
					  $CustomerQuery = $fetchObject->fetchTable('customer',$connection);
					  $count=0;
	...
	<div class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div class="table-responsive">
                              ...
                              <tbody>
							  <?php
							   $getData=$fetchObject->fetchTableAccordingToSorting('soldout','orderid','desc',$connection); 
							   $count=1;
							   while($row=mysqli_fetch_array($getData))
							   {
								   ...
								   //fetch 	`customer` According to `soldout` user i.e uid
								   $data=$fetchObject->fetchTableByAttr('customer','mobile',$user,$connection);
								   $getCustomer=mysqli_fetch_array($data);
								   $customeFName=$getCustomer['firstname'];
								   $customeLName=$getCustomer['lastname'];
							   
							  ?>
                                <tr>
                                  <td><?=$count++?></td>
                                  <td><?=$orderid?></td>
                                  <td><?=$customeFName." ".$customeLName?></td>                                 
                                                             
                                  <td><span class="label label-danger">oreder recieved</span></td>
