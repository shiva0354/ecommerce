...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
	...
	$sql="insert into `returnpolicy`(returnpolicy) values(?)";
	...
	if($stmt)
	{
		echo "<script>alert('Return Policy   Has Been Published.')</script>";
		echo "<script>window.open('return_policy.php','_self')</script>";
	}
	else
	{
