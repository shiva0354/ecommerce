<div class="row text-center" id="mobile-device-filter-sort">
				 ...
				 <div class="dropdown-menu" id="filter">
				     ...
				     <div class="dropdown-item filter-dropdown-item">
					      ...
					      <a class="sb dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $_GET['Men-Clothing'] ;?>&ID=<?php echo $suboptionId;?>"><?php echo $suboptionName ;?></a>
						  <?php } ?>
						  </div>
						  </div>
					 </div>
					 ...
					 <div class="dropdown-item filter-dropdown-item">
					      ...
					      <a class="dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $_GET['Men-Clothing'];?>&Sleeves=SleeveLess">Sleeveless</a>
						  </div>
						  </div>
					 </div>
					 <!--Neck-->
