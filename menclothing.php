...
<?php
	...
	if(isset($_GET['productDOTD']))
	{
		...
		if(isset($DOTDGender))
		{
			$menClothing=$DOTDGender;
			$sql="select * from product where id='$DOTDProId'";
		    $run=mysqli_query($conn,$sql);
		    $data=mysqli_fetch_array($run);
		    $productDesign=$data['product_design'];
		   
		    $tablebycategory=$x->fetchTableByHottestSeller('product','product_design',$productDesign,'product_category',$menClothing);
		}
		else if(isset($_GET['sort-low-2-high']))
	   {
		 $menClothing=$DOTDGender;
	     $tablebycategory = $x->fetchTableBySortOrder('product','asc',$menClothing);
	   }
	   else if(isset($_GET['sort-high-2-low']))
	   {
		 $menClothing=$DOTDGender;
	     $tablebycategory = $x->fetchTableBySortOrder('product','desc',$menClothing);
	   }
	   else if(isset($_GET['new']))
	   {
		  $menClothing=$DOTDGender;
	      $tablebycategory = $x->fetchTableByNewArrival('product','desc',$menClothing);
	   }
	}
				...
				<div class="row">
					...
					<div class="col-md-4">
						<h2 class="clothing-heading">
						 <?php 
						 if(isset($idFromIndex))
						 {echo "New Arrivals Men";}
					     else if(isset($HSProId))
						 {echo "Hottest Seller Men";}
					     else if(isset($DOTDProId))
						 {echo "Design of the Day";}
						 else{echo "Men Clothing";}
						 ?>
						...
						<?php
					      ...
					      <a class="sb dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $menClothing;?>&ID=<?php echo $suboptionId;?>"><?php echo $suboptionName ;?></a>
						  <?php } ?>
					 </div>
					</div>
					</div>
					...
					<div class="category-box">
						...
						?>
					      <a class="dropdown-item" href="mencategory.php?size=<?php echo $sizeofProduct ;?>&Men-Clothing=<?php echo $menClothing?>&ID=<?php echo $suboptionId;?>"><?php echo $sizeName ;?></a>
						<?php } ?>
					...
					<div class="category-box">
					    ...
					    <div class="dropdown-menu">
						   ...
						   ?>
						   <a class="dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $menClothing ;?>&Design=<?php echo $designId ;?>"><?php echo $designName ;?></a>
						   <?php }?>
					 </div>
					</div>
					</div>
					...
					<div class="category-box">
					    ...
					    <div class="dropdown-menu">
					      <a class="dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $menClothing ;?>&Fit=Regular">Regular</a>
					      <a class="dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $menClothing ;?>&Fit=Slim">Slim</a>
					...
					<div class="category-box">
					    ...
					    <div class="dropdown-menu">
					      <a class="dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $menClothing;?>&Sleeves=FullSleeve">Full Sleeve</a>
					      <a class="dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $menClothing;?>&Sleeves=HalfSleeve">Half Sleeve</a>
					      <a class="dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $menclothing;?>&Sleeves=SleeveLess">Sleeceless</a>
					 </div>
					</div>
					</div>
					<br>
					<div class="category-box">
					    ...
					    <div class="dropdown-menu">
					      <a class="dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $menClothing;?>&Neck=RoundNeck">Round Neck</a>
					      <a class="dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $menClothing;?>&Neck=Hood">Hood</a>
					      <a class="dropdown-item" href="mencategory.php?Men-Clothing=<?php echo $menClothing;?>&Neck=TwoPieceCollar">Two Piece Collor</a>
					 </div>
					</div>
					</div>
					<br>
					...
					echo ' 
						<div class="col-md-4">
							<div class="product-box">
						        <a href="single.php?productId='.$productId.'"><img src="data:image/jpeg;base64,'.base64_encode($productImage).'"  height="250" width="250"/></a>
