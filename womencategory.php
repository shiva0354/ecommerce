...
<?php
	...
	if(isset($_GET['size']))
	{
	$tablebycategory = $x->fetchTableByCategory('product',$sizeofProductId,$womenClothing,'id');
	}
	else if(isset($_GET['Women-Clothing'])and isset($_GET['ID']))
	{
	$tablebycategory = $x->fetchTableByCategoryWomen('product',$categoryID,$womenClothing,'product_suboption');
	}
	else if(isset($_GET['Design'])and isset($_GET['Women-Clothing']))
	{
		$tablebycategory = $x->fetchTableByCategoryWomen('product',$productDesign,$womenClothing,'product_design');
	}
	else if(isset($_GET['Fit'])and isset($_GET['Women-Clothing']))
	{
		$tablebycategory = $x->fetchTableByCategoryWomen('product',$productFit,$womenClothing,'product_fit');
	}
	else if(isset($_GET['Sleeves']) and isset($_GET['Women-Clothing']))
	{
	      $tablebycategory = $x->fetchTableByCategoryWomen('product',$productSleeve,$womenClothing,'product_sleeves');
	}
	else if(isset($_GET['Neck'])and isset($_GET['Women-Clothing']))
	{
		$tablebycategory = $x->fetchTableByCategoryWomen('product',$neck,$womenClothing,'product_neck');
	}
?>
			...
			<!--Mobile Device Filter-->
			 ...
			 <br><br><br>
				<div class="row">
					<div class="catbox">
					<div class="col-md-4">
						<h2 class="clothing-heading">Women Clothing
						...
						<div class="filterBOX">
							...
							<span class="clear"><a href="womenclothing.php?Women-Clothing=<?php echo $womenClothing ;?>">clear all</a></span>
						</div>
							<br>
						...
						<?php
						  ...
						  ?>
					      <a class="dropdown-item" href="womencategory.php?Women-Clothing=<?php echo $_GET['Women-Clothing']?>&ID=<?php echo $suboptionId;?>"><?php echo $suboptionName ;?></a>
						  <?php } ?>
					 </div>
					</div>
					</div>
					...
					<div class="category-box">
					    ...
					    <div class="dropdown-menu">
					      ...
					      <a class="dropdown-item" href="womencategory.php?Women-Clothing=<?php echo $_GET['Women-Clothing'];?>&Sleeves=SleeveLess">Sleeve Less</a>
					 </div>
					</div>
					</div>
					<br>
					...
					echo ' 
						<div class="col-md-4">
							<div class="product-box">
						        <a href="single.php?productId='.$productId.'"><img src="data:image/jpeg;base64,'.base64_encode($productImage).'"  height="400"/></a>
